...
def ResNet101_quant(nInputChannels=3, os=16, pretrained=False):
    model = ResNet(nInputChannels, Bottleneck_quant, [3, 4, 23, 3], os, pretrained=pretrained)
    return model
...
def ResNet50_pre(nInputChannels=3, os=16, pretrained=False):
    model = ResNet_pre(nInputChannels, Bottleneck, [3, 4, 6, 3], os, pretrained=pretrained)
    return model
